...
{
  /**
   * Example call to new method {@link HttpHeaders#of}
   * @since 11
   * @see HttpHeaders#of
   */
  ...
  /**
   * Example call to new method {@link HttpHeaders#firstValue}
   * @since 11
   * @see HttpHeaders#firstValue
   */
  ...
  /**
   * Example call to new method {@link HttpHeaders#allValues}
   * @since 11
   * @see HttpHeaders#allValues
   */
  ...
  /**
   * Example call to new method {@link HttpHeaders#firstValueAsLong}
   * @since 11
   * @see HttpHeaders#firstValueAsLong
   */
